                ...
                <form action="{{ route('admin.milestones.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="done_by" class="form-control" required>
                                    ...
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}" @selected(old('done_by') == $user->id)>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="supervisor_note" class="form-control" rows="3"
                                          placeholder="Add feedback for the students...">{{ old('supervisor_note') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding: 0 15px 15px 15px;">
                        <div class="col-md-12 text-right">
                            <a href="{{ route('admin.milestones.index') }}" class="btn btn-default">Cancel</a>
