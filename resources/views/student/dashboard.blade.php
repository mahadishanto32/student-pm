...
@section('content')
    ...
    {{-- Project book status breakdown (scoped to this student's projects) --}}
        ...
        <div class="col-md-6">
            <div class="dark_bg full margin_bottom_30">
                <div class="full graph_head">
                    <div class="heading1 margin_0"><h2>My Assigned Project(s)</h2></div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="content testimonial">
                                @if($myProjects->isEmpty())
                                    <p class="testimonial">You are not assigned to a project yet.</p>
                                @else
                                        ...
                                        <div class="carousel-inner">
                                            @foreach($myProjects as $project)
                                                <div class="item carousel-item @if($loop->first) active @endif">
                                                    ...
                                                    <p class="overview">
                                                        <b>{{ $project->teacher->name ?? 'No supervisor assigned' }}</b>
        ...
        <div class="col-md-6">
            <div class="dash_blog">
                <div class="dash_blog_inner">
                    ...
                    <div class="read_more">
                        <div class="center"><a class="main_bt read_bt" href="{{ route('student.milestones.index') }}">Read More</a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="dash_blog">
                <div class="dash_blog_inner">
                    ...
                    <div class="list_cont">
                        <p>Recent milestone activity on your project(s)</p>
                    </div>
