        ...
        <div class="col-md-12">
            <div class="full white_shadow_bg margin_bottom_30">
                ...
                <div class="row" style="padding: 15px 15px 0 15px;">
                    <div class="col-md-12">
                        <h4>Projects Assigned to Me</h4>
                    </div>
                </div>

                <div class="row" style="padding: 15px;">
                    <div class="col-md-5">
                        <form action="{{ route('teachers.projects.index') }}" method="GET">
                        ...
                        <tbody>
                            @forelse ($projects as $project)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('teachers.projects.show', $project->id) }}"
                                           class="btn btn-sm btn-default" title="View">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="{{ route('teachers.projects.edit', $project->id) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center">No projects assigned to you.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
