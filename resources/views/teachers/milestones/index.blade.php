        ...
        <div class="col-md-12">
            <div class="full white_shadow_bg margin_bottom_30">
                ...
                <div class="row" style="padding: 15px 15px 0 15px;">
                    <div class="col-md-12">
                        <h4>Milestones of My Assigned Projects</h4>
                    </div>
                </div>

                <div class="row" style="padding: 15px;">
                    <div class="col-md-5">
                        <form action="{{ route('teachers.milestones.index') }}" method="GET">
                ...
                <div class="table-responsive" style="padding: 15px;">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($milestone->supervisor_note)
                                            {{ \Illuminate\Support\Str::limit($milestone->supervisor_note, 60) }}
                                        @else
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('teachers.milestones.edit', $milestone->id) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center">No milestones found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
